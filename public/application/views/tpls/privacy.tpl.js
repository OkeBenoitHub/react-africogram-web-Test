...
function PrivacyPolicyText() {
  return (
    <div>
      <center>
        <h2 style={{ color: "#4caf50" }}>Privacy Policy</h2>
      </center>
      <div style={{ margin: "30px", color: "grey" }} id="privacyTpl">
        <p>
          Your privacy is important to us. It is Africogram&#39;s policy to
          ...
          across our website,{" "}
          <a href="https://www.africogram.com">https://www.africogram.com</a>,
          and other sites we own and operate.{" "}
        </p>
        <p>
          This policy is effective as of 14 April 2021 and was last updated on
          14 April 2021.{" "}
        </p>
